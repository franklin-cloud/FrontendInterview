...
var buildConfig = {
outputDir: path.join(\_\_dirname, './dist'),
...
entries[pageName] = {
entry: `src/module/${pageName}/main.js`, // 入口 js
template: 'public/index.html', // 入口模板
title: titlemapper[pageName] || '同学会', // 页面 title
...
archive: [ // 然后我们选择 dist 文件夹将之打包成 dist.zip 并放在根目录
...
pages,
devServer: {
index: 'index.html', // 默认启动 serve 打开 index 页面
...
proxy: null, // 设置代理
// before: app => {}
disableHostCheck: true // 禁用 webpack 热重载检查 解决热更新失效问题
},
